...
export class HuduClient {
  ...
  async getNetworks(params?: {
    ...
    const response = await this.client.get<{ networks: HuduNetwork[] }>('/networks', { params });
    return response.data.networks;
  }

  async getNetwork(id: number): Promise<HuduNetwork> {
    const response = await this.client.get<{ network: HuduNetwork }>(`/networks/${id}`);
  ...
  async getVlans(params?: {
    ...
    const response = await this.client.get<{ vlans: HuduVlan[] }>('/vlans', { params });
    return response.data.vlans;
  }

  async getVlan(id: number): Promise<HuduVlan> {
    const response = await this.client.get<{ vlan: HuduVlan }>(`/vlans/${id}`);
  ...
  async getVlanZones(params?: {
    ...
    const response = await this.client.get<{ vlan_zones: HuduVlanZone[] }>('/vlan_zones', { params });
    return response.data.vlan_zones;
  }

  async getVlanZone(id: number): Promise<HuduVlanZone> {
    const response = await this.client.get<{ vlan_zone: HuduVlanZone }>(`/vlan_zones/${id}`);
  ...
  async getIpAddresses(params?: {
    ...
    const response = await this.client.get<{ ip_addresses: HuduIpAddress[] }>('/ip_addresses', { params });
    return response.data.ip_addresses;
  }

  async getIpAddress(id: number): Promise<HuduIpAddress> {
    const response = await this.client.get<{ ip_address: HuduIpAddress }>(`/ip_addresses/${id}`);
  ...
  async getRackStorages(params?: {
    ...
    const response = await this.client.get<{ rack_storages: HuduRackStorage[] }>('/rack_storages', { params });
    return response.data.rack_storages;
  }
  ...
  async getRackStorageItems(params?: {
    ...
    const response = await this.client.get<{ rack_storage_items: HuduRackStorageItem[] }>('/rack_storage_items', { params });
    return response.data.rack_storage_items;
  }
  ...
  async getPublicPhotos(params?: {
    ...
    const response = await this.client.get<{ public_photos: HuduPublicPhoto[] }>('/public_photos', { params });
    return response.data.public_photos;
  }
  ...
  async cardJump(params: {
    ...
    const response = await this.client.get<{ cards: HuduCard[] }>('/cards/jump', { params });
  ...
  async cardLookup(params: {
    ...
    const response = await this.client.get<{ cards: HuduCard[] }>('/cards/lookup', { params });
    return response.data.cards;
  }
  ...
  async companyJump(params: {
    ...
    const response = await this.client.get<{ companies: HuduCompany[] }>('/companies/jump', { params });
    return response.data.companies;
  }
}